...
st.markdown(
    ...
    /* ---------- Page header bar ---------- */
    .page-head { display:flex; align-items:center; justify-content:space-between; margin: 2px 0 18px 0; }
    .page-head .title { font-size: 28px; font-weight: 900; color:#f8fafc; }
